...
# Generated by qmake (2.01a) (Qt 4.4.3) on: qua dez 10 16:19:47 2008
# Project:  RobotQt.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.4.3/bin/qmake -unix CONFIG+=debug_and_release -o Makefile RobotQt.pro
#############################################################################
...
Makefile: RobotQt.pro  /usr/local/Trolltech/Qt-4.4.3/mkspecs/linux-g++-64/qmake.conf /usr/local/Trolltech/Qt-4.4.3/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix CONFIG+=debug_and_release -o Makefile RobotQt.pro
